      ...
      <div class="form-group required<?php echo $this->error('header', ' has-error'); ?>">
        ...
        <div class="col-md-6">
          ...
          <div class="help-block">
            ...
            <div class="text-muted">
              <?php echo $this->text('How to associate product fields with CSV columns. Each rule must consist of "product data key/column name" pair separated by whitespace. One rule per line'); ?>
            </div>
          </div>
        </div>
      </div>
